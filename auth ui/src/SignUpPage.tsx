      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white w-full">
          ...
          <h1 className="text-5xl font-bold mb-6 leading-tight">
            Your Professional<br />Identity, Reimagined.
          </h1>
          ...
          <div className="space-y-8 max-w-lg">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-bold text-lg mb-1">Get Noticed Instantly</p>
                <p className="text-sm opacity-80 leading-relaxed">Stand out in a crowded market with a portfolio that recruiters actually enjoy exploring.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-bold text-lg mb-1">Prove Your Competence</p>
                <p className="text-sm opacity-80 leading-relaxed">Let your work speak for itself with live code previews and interactive project challenges.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-bold text-lg mb-1">Data-Driven Growth</p>
                <p className="text-sm opacity-80 leading-relaxed">Understand your audience with real-time insights into who is viewing your work and why.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white overflow-y-auto">
        <div className="w-full max-w-md py-12">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Start building your interactive portfolio today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex">
                <span className="inline-flex items-center px-3 border border-r-0 border-gray-300 bg-gray-50 text-gray-500 rounded-l-lg text-sm">mefolio.dev/</span>
                <input
                  name="portfolioUrl"
                  type="text"
                  value={formData.portfolioUrl}
                  onChange={handleChange}
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-transparent outline-none transition text-sm"
            ...
            <label className="flex items-start gap-2 cursor-pointer">
              ...
              <span className="text-sm text-gray-600">I agree to the <a href="#" className="text-indigo-600 hover:text-indigo-700">Terms</a> and <a href="#" className="text-indigo-600 hover:text-indigo-700">Privacy Policy</a></span>
            </label>
          ...
          <p className="mt-8 text-center text-gray-600">
            ...
            <button onClick={onSwitchToSignIn} className="font-medium text-indigo-600 hover:text-indigo-700">Sign in</button>
          </p>
        </div>
      </div>
    </div>
