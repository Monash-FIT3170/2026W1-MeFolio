      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-700 via-violet-700 to-fuchsia-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center px-16 text-white w-full text-center">
          ...
          <p className="text-xl opacity-80 mb-12 max-w-lg leading-relaxed mx-auto">
            Build an interactive showcase that tells your story better than a
            static resume ever could.
          </p>
            ...
            {[
              {
                ...
                desc: "Stand out in a crowded market with a portfolio that recruiters enjoy exploring.",
              },
              {
                icon: <Trophy className="w-6 h-6" />,
                title: "Prove Your Competence",
                desc: "Let your work speak for itself with live code previews and interactive project challenges.",
              },
              {
                icon: <BarChart3 className="w-6 h-6" />,
                title: "Data-Driven Growth",
                desc: "Understand your audience with real-time insights into who is viewing your work and why.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="flex items-start gap-4 p-4 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 transition-colors cursor-default"
              >
        ...
        <div className="w-full max-w-md py-8">
          ...
          <div className="mb-8 text-center lg:text-left">
            ...
            <p className="text-gray-500 text-base">
              Start building your interactive portfolio today
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 text-white py-3 rounded-xl font-bold text-base hover:bg-indigo-700 hover:shadow-lg hover:shadow-indigo-200 transition-all active:scale-[0.98] mt-2"
            >
              Create account
            </button>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center gap-3 py-2.5 px-4 border-2 border-gray-100 rounded-xl hover:border-indigo-600 hover:bg-indigo-50/50 transition-all group"
              >
