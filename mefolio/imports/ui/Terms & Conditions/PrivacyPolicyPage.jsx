  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-3xl mx-auto bg-white p-10 rounded-2xl shadow-sm border border-slate-100">
        <button
          onClick={onBack}
          className="text-indigo-600 font-bold mb-6 hover:underline flex items-center gap-2"
        >
        ...
        <div className="prose prose-indigo max-w-none text-gray-600 space-y-6">
          <section>
            ...
            <p>
              ...
              name, email address, and any professional data you include in your
              portfolio (e.g., resumes, project descriptions, and social links).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              third-party service providers (such as hosting and database
              providers) who perform services on our behalf, subject to strict
          ...
          <section>
            ...
            <p>
              ...
              data, including hashed passwords and encrypted connections.
          ...
          <section>
            ...
            <p>
              ...
              also request a copy of the data we hold about you.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              service and hold certain information to improve your user
              experience.
            </p>
          </section>
        </div>
