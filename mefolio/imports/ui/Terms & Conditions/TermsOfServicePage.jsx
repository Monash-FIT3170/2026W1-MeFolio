      ...
      <div className="max-w-3xl mx-auto bg-white p-10 rounded-2xl shadow-sm border border-slate-100">
        ...
        <div className="prose prose-indigo max-w-none text-gray-600 space-y-6">
          <section>
            ...
            <p>
              By accessing and using MeFolio, you agree to be bound by these
          ...
          <section>
            ...
            <p>
              ...
              MeFolio. However, by posting content, you grant MeFolio a
              worldwide, non-exclusive, royalty-free license to host, display,
              and distribute your content as part of the service.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                Upload or distribute any content that is illegal, harmful, or
                offensive.
              </li>
              <li>
